...
namespace ChampionshipMvc3.Models.DataContext
{
    ...
    partial void DeletePlayfieldOwner(PlayfieldOwner instance);
		...
		public PlayNowDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["RealConnection"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPlayfieldNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PlayfieldOwner_Playfield", Storage="_PlayfieldOwner", ThisKey="OwnerPlayfieldID", OtherKey="OwnerPlayfieldID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	...
	public partial class PlayfieldOwner : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _PriceNoLights;
    ...
    partial void OnPriceLightsChanged();
    partial void OnPriceNoLightsChanging(System.Nullable<int> value);
    partial void OnPriceNoLightsChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PriceNoLights", DbType="Int")]
		public System.Nullable<int> PriceNoLights
		{
			get
			{
				return this._PriceNoLights;
